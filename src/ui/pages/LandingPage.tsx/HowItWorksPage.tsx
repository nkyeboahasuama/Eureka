...
import HeaderStyles from "../../shared_components/header/HeaderStyles";
      ...
      >
        ...
        <BodyContainer w="100%" align="start" style={{ marginTop: "20px" }}>
          ...
          <Typography variant="normal" textalign="left">
            ...
            <span style={{ color: "#03c988", fontWeight: "700" }}>open</span> or{" "}
            <span style={{ color: "#cd1818", fontWeight: "700" }}>closed</span>{" "}
        ...
        <BodyContainer align="start" style={{ marginTop: "20px" }}>
          ...
          <Typography variant="normal" textalign="left">
            ...
            alert is sent out.. You can view and attempt any available question
            in the pool. Finally submit your answer to the question.
          </Typography>
        </BodyContainer>
      </BodyContainer>
